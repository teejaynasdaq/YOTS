...
const PARTNER_URL = 'https://pay.yoco.com/r/yEELDO';
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="p-8 md:p-10 bg-[#1a1a1a] border border-white/10 hover:border-white/20 transition-all duration-300 rounded-sm group">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-white text-black font-bold rounded-sm hover:bg-white/90 transition"
              aria-label="Give Now — opens Yoco giving page"
            >
              Give Now
          ...
          {/* Become a Partner — monthly commitment */}
          <div className="p-8 md:p-10 bg-[#1a1a1a] border border-white/10 hover:border-white/20 transition-all duration-300 rounded-sm group">
            <div className="mb-6">
              <div className="w-14 h-14 rounded-full border border-white/20 flex items-center justify-center mb-6">
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-white text-black font-bold rounded-sm hover:bg-white/90 transition"
              aria-label="Partner Now — opens Yoco partner payment page"
            >
              Partner Now
              <ExternalLink className="w-4 h-4" aria-hidden="true" />
            </a>
